...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-info">
                ...
                <div class='panel-info panel-description'>
                    ...
                    @if($is_admin)
                    <p>You are admin,
                        <a href="{!! URL::route('Classmy.list',['user_id' => $user_id]) !!}">click here</a> to view your created rules
                    </p>
                    @endif
                </div>
                <!--/DESCRIPTION-->
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['route'=>['Classmy.delete', 'id' => @$item->id], 'method' => 'get']) !!}

                    @include('Classmy::admin.Classmy-item')
        ...
        <div class="col-md-3">
            ...
            @include('Classmy::admin.Classmy-search')
