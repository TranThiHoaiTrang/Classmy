...
class CreateClassmyTable extends FoostartMigration
{
    ...
    public function up()
    {
        ...
        Schema::create($this->table, function (Blueprint $table) {
            ...
            // Other attributes
            $table->string($this->prefix_column . 'name', 255)->comment('Classmy name');
            ...
            $table->string($this->prefix_column . 'overview', 1000)->comment('Classmy overview');            
            $table->text($this->prefix_column . 'description')->comment('Classmy description');
            ...
            $table->text($this->prefix_column . 'cache_comments')->nullable()->comment('Comments of Classmy');
            $table->string($this->prefix_column . 'cache_other_Classmy', 1000)->nullable()->comment('The Classmy id of related Classmy ');
